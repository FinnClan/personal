...
import userinterface.InsertNewPatronView;
...
public class Patron extends EntityBase implements IView {
	...
	private InsertNewPatronView patronView;
	...
	public void processNewPatron(Properties props) {
		...
		System.out.println("processNewPatron: starting");
		update();
		System.out.println("processNewPatron: afer update");
		patronView.displayMessage(
			//	"Brandon did this"
				"Patron: " + persistentState.getProperty("name") + " successfully inserted into database"
				);
	...
	public void createDataEntryView() {
		...
		System.out.println("Entered createDataEntryView Patron");
		
		patronView = new InsertNewPatronView(this);
		Scene patronScene = new Scene(patronView);
		swapToView(patronScene);
	...
	public String toString() {
		...
		return persistentState.getProperty("patronId") + " : " + persistentState.getProperty("name") + " : "
				+ persistentState.getProperty("address") + " : " + persistentState.getProperty("city") + " : "
				+ persistentState.getProperty("stateCode") + " : " + persistentState.getProperty("zip") + " : "
				+ persistentState.getProperty("email") + " : " + persistentState.getProperty("dateOfBirth") + " : "
