...
abstract public class Transaction implements IView, IModel {
	 ...
	 *
	 * Transaction remembers all the account IDs for this customer. It uses
	 * AccountCatalog to create this list of account IDs.
	 *
	 */
	// ----------------------------------------------------------
	...
	protected void doYourJob() {
		...
		try {
			...
			new Event(Event.getLeafLevelClassName(this), "Transaction", "Error doYorJobTransaction", Event.ERROR);
		}
	}
	...
	/**
	 * Called via the IView relationship Re-define in sub-class, if necessary
	 */
	// ----------------------------------------------------------
